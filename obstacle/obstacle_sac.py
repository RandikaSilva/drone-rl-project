...
Usage (from IsaacLab directory):
    ...
    source ~/projects/isaac/env_isaaclab/bin/activate && python \
        ~/Desktop/Lasitha/drone_rl_project/drone-rl-project/obstacle/obstacle_sac.py \
...
class ObstacleNavEnv(DirectRLEnv):
    ...
    def _init_lidar_rays(self, n_rays: int):
        ...
        # Horizontal rays: elevation ~ 0 deg -> |sin(el)| < 0.1
    ...
    def _get_observations(self) -> dict:
        """Observations: drone state (9) + goal_pos_b (3) + LiDAR (9) + phase_one_hot (5) + nearest_obstacle (3) = 29."""
...
gym.register(
    id="Isaac-CrazyflieObstacle-SAC-v0",
...
def train():
    ...
    log_root = os.path.join(SCRIPT_DIR, "logs", "sac", "crazyflie_obstacle_nav_sac")
    ...
    env = gym.make("Isaac-CrazyflieObstacle-SAC-v0", cfg=env_cfg)
