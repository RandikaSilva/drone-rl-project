...
VERSION 3 — deterministic proportional LL controller (no checkpoint needed).
...
# v3: No LL checkpoint needed — deterministic proportional controller
...
class HierarchicalObstacleNavEnvCfg(DirectRLEnvCfg):
    ...
    # LL lidar removed in v3 — deterministic controller doesn't need it
...
class HierarchicalObstacleNavEnv(DirectRLEnv):
    ...
    def __init__(self, cfg: HierarchicalObstacleNavEnvCfg, render_mode: str | None = None, **kwargs):
        ...
        # ── v3: No checkpoint — deterministic proportional controller ─────────
        print("[INFO] Low-level: deterministic proportional controller (no checkpoint)")
...
def play():
    ...
    print(f"\n{'='*60}")
    print(f"[INFO] v3: Deterministic proportional LL controller")
    if agent:
